...
#define BLE_FFF0S_SERVER        1
#else
#define BLE_FFF0S_SERVER        0
#endif 

#if defined(CFG_PRF_FTMS)
#define BLE_FTMS_SERVER        1
#else
#define BLE_FTMS_SERVER        0
#endif 
...
/// BLE_SERVER_PRF indicates if at least one server profile is present
        ...
        || BLE_CGM_SERVER || BLE_DBG_THPP||BLE_OADS_SERVER || BLE_FFF0S_SERVER || BLE_FTMS_SERVER)
